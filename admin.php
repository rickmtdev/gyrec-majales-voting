...
$sql = "select
count(*) from majales_votes where vote_id IS NULL;";
$result = mysqli_query($con, $sql);
...
if($_COOKIE["admin_auth"] != "[redacted]") {
    ...
    echo '<head> <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=yes" /> <title>Majáles naruby</title> <link rel="stylesheet" href="src/main.css"> </head>';
